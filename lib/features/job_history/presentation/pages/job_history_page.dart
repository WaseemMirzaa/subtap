  ...
  final List<JobHistory> _allJobs = [
    JobHistory(
      ...
      subcontractorModel: const SubcontractorModel(
        ...
        name: 'James Michael',
        imageUrl: Assets.imagesAvatarImage,
        price: '50',
        rating: 4.0,
      ),
    ),
              ...
              children: [
                ...
                SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      // Add padding to account for toggle buttons height
                      const SizedBox(
                      ...
                      children: [
                        Expanded(
                          child: CustomToggleButton(
                            text: 'Requested Jobs',
                            isActive: _selectedTab == 'Requested Jobs',
                            onTap: () {
                              setState(() {
                                _selectedTab = 'Requested Jobs';
                                _filteredJobs = _allJobs
                                    .where(
                                        (job) => job.status == 'Requested Jobs')
                                    .toList();
                              });
                            },
                          ),
