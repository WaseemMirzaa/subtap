...
class SubcontractorCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: _showInviteSnackbar, // Card tap triggers invite
      child: SizedBox(
        height: 100,
        child: Card(
              ...
              children: [
                GestureDetector(
                  onTap: () => _navigateToProfile(
                      context), // Avatar tap navigates to profile
                  child: Stack(
                    children: [
                      CircleAvatar(
                        radius: 28,
                        ...
                        children: [
                          Flexible(
                            child: GestureDetector(
                              onTap: () => _navigateToProfile(
                                  context), // Name tap navigates to profile
                              child: Text(
                                name,
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              TextButton(
                                onPressed:
                                    _showInviteSnackbar, // Invite button triggers invite
